...
namespace pathTracer {
    int Application::run(int argc, char **argv) {
        ...
        */
        ...
        //auto* white_diffuse = new LambertianReflection({ 1, 1, 1 });
        //auto* light_diffuse = new LambertianReflection({ 0, 0, 0 });
        ...
        auto* short_block_2 = new Quad({ 290, 114, 0 }, { 290, 114, 165 }, { 240, 272, 165 }, { 240, 272, 0 }, specularTransmission, { 0, 0, 0 }, sameSide(block2_vec3, {1, 0, 0}));
        ...
        PathIntegrator* integrator = new PathIntegrator(5, 50);
